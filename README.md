...
resources/
  js/
    Components/           # Vue 3 components
      ...
      CodecheckReviewDisplay.vue
      CodecheckManifestFiles.vue
      CodecheckRepositoryList.vue
    main.js               # Entry point
css/
  codecheck.css           # Minimal plugin styles
public/
...
3. Ensure `public/build/` contains compiled files
4. Test the plugin in OJS
5. Create release tag
6. Package plugin:
   - **Include**: `public/build/`, all PHP files, templates, locale
   - **Exclude**: `node_modules/`, `resources/` (source files)
